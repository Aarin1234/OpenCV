...
path = r"C:\Users\gaura\Documents\pygame one\Open Cv\images_for_collage"
os.chdir(path)
...
def videoGenerator():
    ...
    os.chdir(r'C:\Users\gaura\Documents\pygame one\Open Cv\images_for_collage')
    images = []
    ...
    video.release()
    print('videogenerated successfully. Plz chk ur images')
